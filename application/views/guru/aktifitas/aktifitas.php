            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Aktifitas Pribadi</h4>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>berhasil menambahkan pelanggaran <?php echo $a->nama_pelanggaran; ?> dengan point <?php echo $a->point; ?> kepada siswa bernama <a href="<?php echo base_url(); ?>pelanggaran_siswa_guru/hasil_input/<?php echo $a->id_siswa; ?>"><?php echo $a->nama_siswa; ?></a> kelas <?php echo $a->kelas; ?></td>
