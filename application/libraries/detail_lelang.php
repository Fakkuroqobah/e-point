      ...
      <div class="col">
        <div class="tabs tabs-product mb-2">
          <ul class="nav nav-tabs">
            <li class="nav-item active"><a class="nav-link py-3 px-4" href="#productDescription" data-bs-toggle="tab">Deskripsi</a></li>
            <li class="nav-item"><a class="nav-link py-3 px-4" href="#productInfo" data-bs-toggle="tab">Informasi Tambahan</a></li>
            <li class="nav-item"><a class="nav-link py-3 px-4" href="#riwayatpenawaran" data-bs-toggle="tab">Riwayat Penawaran</a></li>
          </ul>
